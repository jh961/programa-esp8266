...
const int pinfase = 14; // pin que sensa el cruce por cero. 
const float tfas=0.92;   // tiempo en que se habilita el cilo util. 
...
*/
 ...
 //IPAddress ip(192,168,0,121); // where xx is the desired IP Address MARGARITA
  IPAddress ip(192,168,1,121); // where xx is the desired IP Address DOMOHOUSE
  IPAddress gateway(192,168,1,1); // set gateway to match your network
  IPAddress subnet(255,255,255, 0); // set subnet mask to match your network
...
if((normal == 1)||(deshabilitado == 1)){
  ...
  */
  ...
  s +="<th colspan='2'><font color='#2E2E2E' size='4' align='center' face='Jokerman'><a href='http://"+ipservidor+"/Modulabit1.html'><img src='https://lh3.googleusercontent.com/icNVOxOjEImPwCDlvNTuL2Vgh__u0aUvLHyPchwonYLh_giovND3EKEyht8azp2yGvBcyG2EaVkCuAKHzd7L1yM9Gar_Nci0MpaSaO71qqSK_e7J0Lp7zknqUkVRW4oro7BWdRrm0Jk8jeV64tVcTCixRBSqu4k6_Esb0WbBxqMzvK93nrDg0-PnVc0nXIccJJGS23GUoOoYs5voEhvVQqe0SbaBU_wX-DOZka02LwIO1wMoF4odm8UpO4sWxcd2kZaB2RN6eADjO6QoRgqD0nJjUZuAdbiVmrFbrhsNjHQ8uttUaF1sCh2ik6nrJKH3MdH5LuNp9MrNtXWPP4xl95X7mk53F684mXl0qfNlIv2bMcv7rmyjaJkyPiz7p8tjCAndDI6pqgifDHaPCdso4H9ibY5pj3lfd1wQVpiW_VE1445tbp1u1-MDriGMIHCVoA_-Kk9jpDLv8fpxT2Sapuan8oFQCOr23--h_XMvecxj7IeFv_TM5quJ0riEVUChhHJnPz91eB-6aVR1gmUoeZrnX7sk3HA8YmHBS9fsYDIm_Y3erjLap9CB4Rzw2gskj5qPm2rGqKpIxUxGCJqI-FDoF3Awn8k=w601-h103-no' border='4' width='200' height='80' ><br>HABITACION 1</a></font></th>";
  s +="</tr>";
  s +="</table>";
